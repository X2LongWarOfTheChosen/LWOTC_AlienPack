...
static function X2DataTemplate CreateTemplate_Naja_WPN(name TemplateName)
{
	...
	//Template.Abilities.AddItem('Overwatch');  // updated to sniper for move-or-fire
	...
	{
		Template.Abilities.AddItem('DamnGoodGround_AP');
	}
	...
	// This all the resources; sounds, animations, models, physics, the works.
	Template.GameArchetype = "NajaRifle.WP_NajaRifle";  // TODO: refine model as needed
...
static function X2DataTemplate CreateTemplate_Sidewinder_WPN(name TemplateName)
{
	...
	Template.WeaponCat = 'rifle';
	Template.WeaponTech = 'beam';
	Template.strImage = "img:///LWSidewinderSMG.Textures.LWBeamSMG_Common";  // TODO : upgrade weapon panel image
	Template.RemoveTemplateAvailablility(Template.BITFIELD_GAMEAREA_Multiplayer); //invalidates multiplayer availability
	...
	if (TemplateName == 'SidewinderM1_WPN' || TemplateName == 'NajaM2_WPN' || TemplateName == 'NajaM3_WPN')
	{
		//future use
	}
...
static function X2DataTemplate CreateTemplate_AdvGunner_WPN(name TemplateName)
{
	...
	Template.WeaponCat = 'cannon';
	Template.WeaponTech = 'magnetic';
	Template.strImage = "img:///UILibrary_Common.UI_MagCannon.MagCannon_Base"; // TODO : upgrade weapon panel image
	Template.RemoveTemplateAvailablility(Template.BITFIELD_GAMEAREA_Multiplayer); //invalidates multiplayer availability
	...
	Template.Abilities.AddItem('Reload');
	Template.Abilities.AddItem('HotLoadAmmo');
	Template.Abilities.AddItem('AreaSuppression_AP');

	if (TemplateName == 'AdvGunnerM2_WPN' || TemplateName == 'AdvGunnerM3_WPN')
	{
		Template.Abilities.AddItem('LockedOn_AP');
	}
	if (TemplateName == 'AdvGunnerM3_WPN')
	{
...
static function X2DataTemplate CreateTemplate_AdvSentry_WPN(name TemplateName)
{
	...
	if (TemplateName == 'AdvSentryM2_WPN' || TemplateName == 'AdvSentryM3_WPN')
	{
...
static function X2DataTemplate CreateTemplate_AdvGrenadier_GrenadeLauncher(name TemplateName)
{
	...
	Template.strImage = "img:///UILibrary_Common.MagSecondaryWeapons.MagLauncher"; // TODO:SWITCH TO CV
...
static function X2DataTemplate CreateTemplate_LWDroneRepair_WPN(name TemplateName)
{
	...
	Template.WeaponCat = 'rifle';
	Template.WeaponTech = 'magnetic';
	Template.strImage = "img:///UILibrary_Common.AlienWeapons.GatekeeperEyeball"; // TODO : replace this
	Template.RemoveTemplateAvailablility(Template.BITFIELD_GAMEAREA_Multiplayer); //invalidates multiplayer availability
